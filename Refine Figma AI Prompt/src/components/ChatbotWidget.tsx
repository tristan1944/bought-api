        ...
        <div className="absolute bottom-20 right-0 w-[420px] h-[700px] bg-white rounded-3xl shadow-2xl flex flex-col overflow-hidden animate-in fade-in slide-in-from-bottom-4 duration-300">
          ...
          <div className="flex-1 overflow-y-auto px-6 py-8 bg-gray-50">
            ...
            <div className="text-center mb-8">
              ...
              <h3 className="text-gray-900 mb-2">{config.bannerTitle}</h3>
              <p className="text-gray-600">{config.bannerDescription}</p>
            </div>
            ...
            <div className="flex flex-wrap gap-2">
              <button className="text-gray-700 hover:text-gray-900 text-sm transition-colors">
                Get started
              </button>
              <button className="text-gray-700 hover:text-gray-900 text-sm transition-colors">
                See templates
          ...
          <div className="px-6 py-4 bg-white">
            ...
            <p className="text-center text-xs text-gray-400">Powered by Voiceflow</p>
          </div>
        </div>
      )}
